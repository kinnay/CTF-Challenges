...
def save_data(data):
    ...
    with closing(gzip.GzipFile("magic_data_"+str(output_bits_length), "w")) as f:
        pickle.dump([b.tobytes().rstrip(b"\0") for b in data_masked], f)
    print("Done.")
...
def main():
    ...
    rng_data = [rnd.getrandbits(32) & ((1 << output_bits_length) - 1) for _ in range(bits1//output_bits_length)]
